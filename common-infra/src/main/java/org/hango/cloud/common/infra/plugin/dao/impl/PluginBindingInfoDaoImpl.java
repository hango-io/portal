...
public class PluginBindingInfoDaoImpl extends BaseDao implements IPluginBindingInfoDao {
    ...
    public long add(PluginBindingInfo pluginBindingInfo) {
        ...
        String sql = "insert into hango_plugin_binding (plugin_type, binding_object_id, binding_object_type, plugin_configuration, create_time, update_time, virtual_gw_id, project_id, binding_status, template_id, template_version, gw_type)" + " values (:pluginType, :bindingObjectId, :bindingObjectType, :pluginConfiguration, :createTime, :updateTime, :virtualGwId, :projectId, :bindingStatus, :templateId, :templateVersion, :gwType)";
