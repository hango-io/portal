...
public class PluginTemplateDaoImpl extends BaseDao implements IPluginTemplateDao {
    ...
    public long add(PluginTemplateInfo pluginTemplateInfo) {
        ...
        String sql = "insert into hango_plugin_template (create_time, update_time, plugin_type, plugin_configuration, project_id, template_version, template_name, template_notes) "
