...
public class OperationAuditKind {
    ...
    static {
        ...
        kindMap.put("DeletePlugin", OperationAuditRule.get().eventName("DeletePlugin").description("删除架插件").resourceType(AuditConst.AUDIT_RESOURCE_TYPE_PLUGIN).jsonPathForRSIReq("$.Id"));
        /*********************************************** plugin end *****************************************************/
