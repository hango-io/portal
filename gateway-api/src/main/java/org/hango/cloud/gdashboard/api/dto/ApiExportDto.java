...
public class ApiExportDto {
    ...
    @JSONField(name = "DubboParam")
    private List<DubboParamInfoDto> dubboParamDtos;
    @JSONField(name = "WebserviceParam")
    private WebServiceParamInfoDto webServiceParamDtos;
    ...
    public List<DubboParamInfoDto> getDubboParamDtos() {
        return dubboParamDtos;
    }

    public void setDubboParamDtos(List<DubboParamInfoDto> dubboParamDtos) {
        this.dubboParamDtos = dubboParamDtos;
    }

    public WebServiceParamInfoDto getWebServiceParamDtos() {
        return webServiceParamDtos;
    }

    public void setWebServiceParamDtos(WebServiceParamInfoDto webServiceParamDtos) {
        this.webServiceParamDtos = webServiceParamDtos;
    }
}
