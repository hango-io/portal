...
public class EnvoyRouteWsParamDaoImpl extends BaseDao implements EnvoyRouteWsParamDao {
    @Override
    public EnvoyRouteWsParamInfo getByRoute(long gwId, long serviceId, long routeId) {
        String sql = "select * from apigw_envoy_route_ws_param_info where gw_id=:gwId and service_id=:serviceId and route_id=:routeId";
        MapSqlParameterSource ps = new MapSqlParameterSource();
        ps.addValue("gwId", gwId);
    ...
    public long add(EnvoyRouteWsParamInfo envoyRouteWsParamInfo) {
        ...
        String sql = "insert into apigw_envoy_route_ws_param_info (create_date, modify_date, gw_id, service_id, route_id, request_template, response_array_type_list, ws_port_type, ws_operation, ws_binding, ws_address) "
                + " values (:createDate, :modifyDate, :gwId, :serviceId, :routeId, :requestTemplate, :responseArrayTypeList, :wsPortType, :wsOperation, :wsBinding, :wsAddress)";
        MapSqlParameterSource ps = new MapSqlParameterSource();
        ps.addValue("createDate", envoyRouteWsParamInfo.getCreateDate());
        ps.addValue("modifyDate", envoyRouteWsParamInfo.getModifyDate());
        ps.addValue("gwId", envoyRouteWsParamInfo.getGwId());
    ...
    @Override
    public long update(EnvoyRouteWsParamInfo envoyRouteWsParamInfo) {
        String sql = "update apigw_envoy_route_ws_param_info set modify_date=:modifyDate, gw_id=:gwId, service_id=:serviceId, route_id=:routeId, " +
    ...
    public int delete(EnvoyRouteWsParamInfo envoyRouteWsParamInfo) {
        String sql = "delete from apigw_envoy_route_ws_param_info where id = :id";
    ...
    public EnvoyRouteWsParamInfo get(long id) {
        String sql = "select * from apigw_envoy_route_ws_param_info where id = :id";
    ...
    public List<EnvoyRouteWsParamInfo> findAll() {
        String sql = "select * from apigw_envoy_route_ws_param_info order by id desc";
    ...
    public List<EnvoyRouteWsParamInfo> getRecordsByField(Map<String, Object> params) {
        String head = "select * from apigw_envoy_route_ws_param_info where ";
    ...
    public int getCountByFields(Map<String, Object> params) {
        String head = "select count(*) from apigw_envoy_route_ws_param_info where ";
        String sql = getQueryCondition(head, params);
    ...
    class ServiceWsProxyInfoRowMapper implements RowMapper<EnvoyRouteWsParamInfo> {
        ...
        public EnvoyRouteWsParamInfo mapRow(ResultSet rs, int rowNum) throws SQLException {
            ...
            wsProxyInfo.setGwId(rs.getLong("gw_id"));
