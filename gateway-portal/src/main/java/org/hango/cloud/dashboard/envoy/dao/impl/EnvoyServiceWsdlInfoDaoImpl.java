...
public class EnvoyServiceWsdlInfoDaoImpl extends BaseDao implements EnvoyServiceWsdlInfoDao {
    @Override
    public int deleteByServiceId(long gwId, long serviceId) {
        String sql = "delete from apigw_envoy_service_wsdl_info where gw_id =:gwId and service_id = :serviceId";
        return namedParameterJdbcTemplate.update(sql, new MapSqlParameterSource(ImmutableMap.of("gwId", gwId, "serviceId", serviceId)));
    }

    @Override
    public EnvoyServiceWsdlInfo getByServiceId(long gwId, long serviceId) {
        String sql = "select * from apigw_envoy_service_wsdl_info where gw_id =:gwId and service_id = :serviceId";
        return queryForObject(sql, new MapSqlParameterSource(ImmutableMap.of("gwId", gwId, "serviceId", serviceId)), new ServiceWsInfoRowMapper());
    }

    @Override
    public long add(EnvoyServiceWsdlInfo envoyServiceWsdlInfo) {
        KeyHolder keyHolder = new GeneratedKeyHolder();
        String sql = "insert into apigw_envoy_service_wsdl_info (create_date, modify_date, gw_id, service_id, wsdl_file_name, wsdl_file_content, wsdl_binding_list) "
                + " values (:createDate, :modifyDate, :gwId, :serviceId,:wsdlFileName,:wsdlFileContent,:wsdlBindingList)";
        ...
        ps.addValue("gwId", envoyServiceWsdlInfo.getGwId());
    ...
    @Override
    public long update(EnvoyServiceWsdlInfo envoyServiceWsdlInfo) {
        String sql = "update apigw_envoy_service_wsdl_info set modify_date = :modifyDate, service_id = :serviceId, wsdl_file_name=:wsdlFileName, " +
    ...
    public int delete(EnvoyServiceWsdlInfo envoyServiceWsdlInfo) {
        String sql = "DELETE from apigw_envoy_service_wsdl_info where id = :id";
    ...
    public EnvoyServiceWsdlInfo get(long id) {
        String sql = "select * from apigw_envoy_service_wsdl_info where id = :id";
    ...
    public List<EnvoyServiceWsdlInfo> findAll() {
        String sql = "select * from apigw_envoy_service_wsdl_info order by id desc";
    ...
    public List<EnvoyServiceWsdlInfo> getRecordsByField(Map<String, Object> params) {
        String head = "select * from apigw_envoy_service_wsdl_info where ";
    ...
    public int getCountByFields(Map<String, Object> params) {
        String head = "select count(*) from apigw_envoy_service_wsdl_info where ";
        String sql = getQueryCondition(head, params);
