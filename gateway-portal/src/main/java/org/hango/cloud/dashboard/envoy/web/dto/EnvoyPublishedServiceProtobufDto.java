...
public class EnvoyPublishedServiceProtobufDto {
    ...
    public EnvoyPublishedServiceProtobufDto(EnvoyServiceProtobufProxy serviceProtobufProxy, long gwId, String gwName, String[] serviceAddr) {
    ...
    public static EnvoyPublishedServiceProtobufDto getFromProtoMeta(EnvoyServiceProtobufDto envoyServiceProtobufDto) {
        ...
        envoyPublishedServiceProtobufDto.setGwId(envoyServiceProtobufDto.getGwId());
    ...
    public EnvoyServiceProtobufProxy toMeta() {
        ...
        envoyServiceProtobufProxy.setGwId(this.getGwId());
