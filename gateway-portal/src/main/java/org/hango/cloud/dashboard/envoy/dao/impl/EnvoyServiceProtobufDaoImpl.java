...
public class EnvoyServiceProtobufDaoImpl extends BaseDao implements EnvoyServiceProtobufDao {
    ...
    public long add(EnvoyServiceProtobuf serviceProtobuf) {
        ...
        String sql = "insert into apigw_envoy_service_protobuf (create_date, modify_date, service_id, pb_file_name, pb_file_content, pb_service_list) "
    ...
    @Override
    public long update(EnvoyServiceProtobuf serviceProtobuf) {
        String sql = "update apigw_envoy_service_protobuf set modify_date = :modifyDate, service_id = :serviceId, pb_file_name=:pbFileName, " +
    ...
    public int delete(EnvoyServiceProtobuf serviceProtobuf) {
        String sql = "DELETE from apigw_envoy_service_protobuf where id = :id";
    ...
    public int delete(long serviceId) {
        String sql = "DELETE from apigw_envoy_service_protobuf where service_id = :serviceId";
    ...
    public EnvoyServiceProtobuf get(long id) {
        String sql = "select * from apigw_envoy_service_protobuf where id = :id";
    ...
    public List<EnvoyServiceProtobuf> findAll() {
        String sql = "select * from apigw_envoy_service_protobuf order by id desc";
    ...
    public List<EnvoyServiceProtobuf> getRecordsByField(Map<String, Object> params) {
        String head = "select * from apigw_envoy_service_protobuf where ";
    ...
    public int getCountByFields(Map<String, Object> params) {
        String head = "select count(*) from apigw_envoy_service_protobuf where ";
        String sql = getQueryCondition(head, params);
