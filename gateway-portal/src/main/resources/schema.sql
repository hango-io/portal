CREATE TABLE IF NOT EXISTS apigw_gportal_api (
 ...
 CREATE TABLE IF NOT EXISTS apigw_gportal_dubbo_meta (
    ...
    update apigw_service_proxy set registry_center_type='Kubernetes' where publish_type='DYNAMIC';

    update apigw_gportal_gateway_info set project_id = '' where gw_type = 'envoy';


    alter table apigw_gportal_registry_center add COLUMN project_id bigint(20) NULL ;
    alter table apigw_gportal_registry_center add COLUMN is_shared tinyint(4) NULL ;

    alter table apigw_gportal_registry_center add COLUMN gw_id BIGINT(20) NULL;
 ...
 CREATE TABLE IF NOT EXISTS apigw_envoy_plugin_template (
    ...
    alter table apigw_envoy_health_check_rule add COLUMN min_health_percent tinyint(4) DEFAULT 50 ;
