...
public class EnvoyServiceWsdlInfoDaoImpl extends BaseDao implements EnvoyServiceWsdlInfoDao {
    ...
    @Override
    public EnvoyServiceWsdlInfo getByServiceId(long serviceId) {
        String sql = "select * from hango_service_wsdl_info where service_id = :serviceId";
        return queryForObject(sql, new MapSqlParameterSource(ImmutableMap.of("serviceId", serviceId)), new ServiceWsInfoRowMapper());
    }
