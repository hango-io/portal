...
public interface ITrafficMarkService {
     ...
     */
    boolean isTrafficColorExists(String routeRuleIds,String colorTag);
    ...
    List<TrafficMarkInfo> getTrafficColorRulesByRouteId(long routeId);
    List<TrafficMarkInfo> getTrafficColorRulesByRouteId(long routeId,String colorTag);
}
