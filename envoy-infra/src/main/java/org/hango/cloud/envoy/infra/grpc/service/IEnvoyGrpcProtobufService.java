...
public interface IEnvoyGrpcProtobufService {
     ...
     * @return
     */
    EnvoyServiceProtobufProxy getServiceProtobufProxy(long serviceId, long virtualGwId);
     ...
     * @return
     */
    ErrorCode offlineServiceProtobuf(long serviceId, long virtualGatewayId);
     ...
     * @return
     */
    Pair<ErrorCode, PbCompileResultDto> checkPublishPbFile(long serviceId, long virtualGwId, MultipartFile file, List<String> pbServiceList);
    ...
    ErrorCode checkOfflinePbFile(long serviceId, long virtualGwId);
}
