...
public class EnvoyErrorCode extends ErrorCode {
    ...
    public static ErrorCode INVALID_PUBLISH_OPERATION = new EnvoyErrorCode(EnvoyErrorCodeEnum.INVALID_PUBLISH_OPERATION);
    ...
    public static ErrorCode TRAFFIC_COLOR_RULE_ALREADY_EXIST = new EnvoyErrorCode(EnvoyErrorCodeEnum.TRAFFIC_COLOR_RULE_ALREADY_EXIST);
