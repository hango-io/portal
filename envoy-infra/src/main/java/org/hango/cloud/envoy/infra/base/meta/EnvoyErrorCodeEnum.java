...
public enum EnvoyErrorCodeEnum {
    ...
    COULD_NOT_OFFLINE_SERVICE("CouldNotOfflineService", "You couldn't offline a service before offline protobuf.", "在未下线该服务下pb文件前，不允许下线服务", 400),
    ...
    TRAFFIC_COLOR_RULE_ALREADY_EXIST("TrafficColorRuleAlreadyExist", "TrafficColorRule is already exist in this service and route.", "当前服务和路由下已经存在流量染色规则", 400),
