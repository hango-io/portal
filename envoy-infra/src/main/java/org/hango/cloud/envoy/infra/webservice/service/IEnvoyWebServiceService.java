package org.hango.cloud.envoy.infra.webservice.service;
...
public interface IEnvoyWebServiceService {
     ...
     * @return wsdl检验结果
     */
    ErrorCode checkUploadWsdlFile(long virtualGwIdx, long serviceId, MultipartFile wsdlFile);
     ...
     * @return 服务下的wsdl信息
     */
    EnvoyServiceWsdlInfo getServiceWsdlInfo(long virtualGwId, long serviceId);
     ...
     * @return 删除结果
     */
    ErrorCode deleteServiceWsdlInfo(long virtualGwId, long serviceId);
     ...
     * @return 结果状态
     */
    EnvoyRouteWsParamInfo getRouteProxyWsParam(long virtualGwId, long serviceId, long routeId);
     ...
     * @return 结果状态
     */
    ErrorCode deleteRouteProxyWsParam(long virtualGwId, long serviceId, long routeId);
     ...
     */
    Map<String, Object> createWsRequestTemplate(long virtualGwId, long serviceId, String wsPortType, String wsOperation, String wsBinding);
