...
public class TrafficMarkDaoImpl extends BaseDao implements ITrafficMarkDao {
    ...
    @Override
    public List<TrafficMarkInfo> getTrafficColorRulesByRouteRuleId(long routeRuleId,String colorTag) {
        String sql = "select * from apigw_gportal_entry_traffic_policy where route_rule_ids = :routeRuleId";
        Map<String, Object> params = Maps.newHashMap();
        params.put("routeRuleId", routeRuleId);
        if (StringUtils.isNotBlank(colorTag)){
            params.put("colorTag", colorTag);
            sql = sql + " and color_tag = :colorTag";
        }
