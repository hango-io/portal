...
public class EnvoyWebServiceServiceImpl implements IEnvoyWebServiceService {
    ...
    public ErrorCode checkUploadWsdlFile(long virtualGwId, long serviceId, MultipartFile wsdlFile) {
        ...
        try {
            ...
            EnvoyServiceWsdlInfo oldWsdlInfo = envoyServiceWsdlInfoDao.getByServiceId(serviceId);
    ...
    @Override
    public EnvoyServiceWsdlInfo getServiceWsdlInfo(long serviceId) {
        return envoyServiceWsdlInfoDao.getByServiceId(serviceId);
    }

    @Override
    public ErrorCode deleteServiceWsdlInfo(long virtualGwId, long serviceId) {
        // 获取服务上的wsdl信息
        EnvoyServiceWsdlInfo wsdlInfo = getServiceWsdlInfo(serviceId);
