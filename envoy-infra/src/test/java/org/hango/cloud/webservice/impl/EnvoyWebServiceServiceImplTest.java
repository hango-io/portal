...
public class EnvoyWebServiceServiceImplTest extends BaseServiceImplTest {
    ...
    public void testGetServiceWsdlInfo() {
        EnvoyServiceWsdlInfo serviceWsdlInfo = envoyWebServiceService.getServiceWsdlInfo(mockVirtualGwId, mockServiceId);
        Assert.assertEquals(mockWsdlFileContent, serviceWsdlInfo.getWsdlFileContent());
    }
    ...
    public void testDeleteServiceWsdlInfo() {
        ...
        Assert.assertEquals(CommonErrorCode.SUCCESS, errorCode);
    }
    ...
    public void testSOAModel() throws Exception {
        ...
        if (wsdlDirectory.isDirectory()) {
            ...
            for (File wsdl : wsdls) {
                Assert.assertTrue(checkWsdl(wsdl.toPath()));
                //打印略
