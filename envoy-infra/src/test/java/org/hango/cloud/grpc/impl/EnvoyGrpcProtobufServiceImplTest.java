...
//        assertEquals(serviceProtobuf.getPbFileName(), mockFileName);
//    }
//
////    @Test
...
////        assertEquals(serviceProtobufProxy.getPbFileName(), mockFileName);
////    }
//
//    @Test
...
//        assertTrue(envoyServiceProtobufList.size() > 0);
//    }
//
...
//        assertTrue(envoyPublishedServiceProtobufDtoList.size() > 0);
//    }
//
//    @Test
...
//                    assertEquals(PbService.PUBLISH_STATUS_NOT_PUBLISHED, pbServiceDto.getPublishStatus());
//                    break;
//                case GREETER0_SERVICE:
//                case GREETER2_SERVICE:
//                default:
//                    assertEquals(PbService.PUBLISH_STATUS_PUBLISHED, pbServiceDto.getPublishStatus());
//                    break;
//            }
//        }
//
