...
public class BaseServiceImplTest {
  ...
  /****************************** 共享对象（继承此类的单元测试类公用） ******************************/
  public  ServiceProxyDto serviceDto;
  ...
  public void initRoute(RouteDto routeDto){
    routeDto = new RouteDto();
    routeDto.setVirtualGwId(1L);
    routeDto.setEnableState(PLUGIN_STATUS);
    ...
    routeDto.setHttpRetryDto(httpRetryDto);
    routeDto.setHeaders(routeDto.getHeaders());
    routeDto.setQueryParams(routeDto.getQueryParams());
    routeDto.setMethod(routeDto.getMethod());
    routeDto.setUriMatchDto(routeDto.getUriMatchDto());
    ...
    serviceMeta.setServiceId(1L);
    serviceMeta.setDestinationServices(null);
    serviceMeta.setBackendService("127.0.0.1");
    serviceMeta.setProtocol("http");
    serviceMeta.setPort(80);
    serviceMeta.setServiceName("test service");
    serviceMeta.setWeight(100);
    serviceMetaForRouteDtos.add(serviceMeta);
    routeDto.setServiceMetaForRouteDtos(serviceMetaForRouteDtos);
  }
